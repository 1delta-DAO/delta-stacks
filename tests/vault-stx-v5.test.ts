...
const VAULT    = `${deployer}.vault-stx-v5`
...
describe('vault-v5 — auto-allocation: proportional deposit split', () => {
...
describe('vault-v5 — overflow and underflow protection', () => {
...
describe('vault-v5 — safe rounding', () => {
...
describe('vault-v5 — proportional withdrawal', () => {
...
describe('vault-v5 — yield sync + auto-allocation interaction', () => {
...
describe('vault-v5 — deposit succeeds even without valid adapter trait', () => {
...
describe('vault-v5 — share price correctness', () => {
...
describe('vault-v5 — access control', () => {
...
describe('vault-v5 — recall (market -> idle)', () => {
...
describe('vault-v5 — performance fees', () => {
...
describe('vault-v5 — zero-sum rebalancing', () => {
