...
const VAULT    = `${deployer}.vault-stx-v4`
...
describe('vault-v4 — auto-allocation: proportional deposit split', () => {
...
describe('vault-v4 — overflow and underflow protection', () => {
...
describe('vault-v4 — safe rounding', () => {
...
describe('vault-v4 — proportional withdrawal', () => {
...
describe('vault-v4 — yield sync + auto-allocation interaction', () => {
...
describe('vault-v4 — deposit succeeds even without valid adapter trait', () => {
...
describe('vault-v4 — share price correctness', () => {
...
describe('vault-v4 — access control', () => {
...
describe('vault-v4 — recall (market -> idle)', () => {
...
describe('vault-v4 — performance fees', () => {
...
describe('vault-v4 — zero-sum rebalancing', () => {
