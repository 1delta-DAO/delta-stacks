...
export interface StacksLenderOptions {
  ...
  concurrency?: number
  /**
   * Use the deployed aggregator contract (1 call instead of 39/60).
   * Requires zest-reader to be deployed on-chain.
 ...
 * to the zest-reader contract instead of N individual calls.
 */
