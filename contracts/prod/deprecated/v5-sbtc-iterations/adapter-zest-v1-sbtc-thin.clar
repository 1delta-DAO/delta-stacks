;; adapter-zest-v1-sbtc-thin.clar
;;
;; Ultra-thin Zest V1 sBTC adapter -- splits withdraw into pull + forward
;; to minimize stack depth during borrow-helper.withdraw.
;;
;; The `pull` function is a single compound expression with no begin/try/let.
;; Also implements lending-adapter-trait for deposit/get-position.
