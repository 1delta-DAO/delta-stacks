;; adapter-zest-v1-sbtc-thin-v3.clar
;;
;; Ultra-thin Zest V1 sBTC adapter with disable-collateral (accepts price-feed-bytes).
...
;; Forward sBTC from adapter to recipient
(define-public (forward (amount uint) (to principal))
  (as-contract
    (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
      transfer amount tx-sender to none)))

;; Disable collateral -- accepts price-feed-bytes for Pyth oracle
