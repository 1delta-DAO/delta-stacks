...
;; Default: USDCx mainnet
(define-data-var base-asset principal 'SP120SBRBQJ00MCWS7TM5R8WJNTTKD5K0HFRC2CNE.usdcx)
(define-data-var virtual-offset uint u1000000)  ;; 10^6 for USDCx
(define-data-var vault-initialized bool false)

;; --- Configurable SIP-010 share metadata ---
(define-data-var vault-name     (string-ascii 32) "1delta USDCx Vault v3")
(define-data-var vault-symbol   (string-ascii 10) "1dUSDCx")
